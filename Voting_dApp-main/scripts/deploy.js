...
async function main() {
  ...
  const deployer = signers[0]; // <-- change index to choose account
  ...
  fs.writeFileSync(path.join(contractDir, "contract-address.json"), JSON.stringify({ Voting: voting.target }, null, 2));
